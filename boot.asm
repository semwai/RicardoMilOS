...
mov al, 7  ;берем из диска 5 сектора (512байт*5)
mov bx, 0x8008 ; адрес в оперативной памяти для вставки данных
mov ch, 0 ; )
mov cl, 2 ; )
mov dh, 0 ;)
mov dl, 0x80 ;)
...
;mov bx, 0x9400
;mov ch, 0
;mov cl, 35 ; 2 = 400 ,  4=600   , 30 = 0x3200  35=0х4400
;mov dh, 0
;mov dl, 0x80
;int 0x13
...
mov sp, 0xFFFC ; выставляем значение положения стека
...
jmp MYCODE:0x8008 ; прыгаем на выполнение нашей основной программы (main.c которая)
